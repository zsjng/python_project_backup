...
excelFile = r'C:\Users\chen\PycharmProjects\建模\1.xlsx'
...
for i in range(0, x.shape[1], 1):
    ...
    win_rate = win_rate.append(pd.DataFrame(
        {'win_rate': win, 'profit': profit, 'profit_year': profit_year, 'max_retracement': max_retracement}, index=[0]))
    ...
    win_rate.to_excel('./win_rate1.0_new.xlsx')
    win_rate2.to_excel('./win_rate2.0_new.xlsx')
